                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-2.5 mb-1">
                        <TestProgressBar currentStatus={test.testStatus} testCatalogId={test.testCatalogId} caseId={caseData.id} testOrderId={test.id} testDescription={test.testDescription} hasMroHistory={test.documents.some((d) => d.documentType === "correspondence")} applicationDate={test.patchDetails?.applicationDate ?? null} removalDate={test.patchDetails?.removalDate ?? null} onUpdated={loadCase} />
                      </div>
